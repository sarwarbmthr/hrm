...
class Employee(models.Model):
    ...
    visa_expire_date = models.DateField(null=True, blank=True, verbose_name=_("Visa Expiry Date"))
...
ACCESSBILITY_FEATURE.append(("visa_expiry_view", "Can view Visa Expiry"))
